            ...
            <div class="panel-body   ">
               ...
               <div class="row">
                  <div class='col-sm-6 form-group' >
                     ...
                     <?php 
                     $service_type =  ArrayHelper::map(CategoryManagement::find()->where(['active_status'=>"1"])->all(),'auto_id','category_name');
                     ?>
                     <?= $form->field($model, 'service_id')->dropDownList($service_type,['prompt'=>'--Select Product--','maxlength' => true,'class'=>'form-control upper','required'=>true])->label(false) ?>
                  </div>
                  <div class='col-sm-6 form-group' >
                  ...
                  <div class='col-sm-6 form-group' >
                     ...
                     <?= $form->field($model, 'brands')->textInput(['id'=> 'brands','maxlength' => true,'class'=>'form-control upper','placeholder'=>'Brand'])->label(false) ?>
                  </div>
