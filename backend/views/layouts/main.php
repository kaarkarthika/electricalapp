...
<div class="wrapper">
     <header class="main-header">
        ...
        <!-- <a href="<?= Yii::$app->homeUrl ?>" class="logo"> -->
         <a class="logo" href="<?= Yii::$app->homeUrl ?>">Pooja Electrical</a>
                  ...
                  <li class="user-footer">
                    <?php
                     if($_SESSION['user_logintype']=="EX"){
                      ?>
                       <div class="pull-left">
                      <a href='<?php echo Yii::$app->homeUrl."?r=executive-master/view&id=".$session['user_id']; ?>' class="btn btn-default btn-flat"><i class="fa fa-fw fa-user"></i> Profile</a>
                    </div>
                   <?php  }else{
                    ?>
                    <div class="pull-left">
