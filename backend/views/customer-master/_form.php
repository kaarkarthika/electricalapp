            ...
            <div class="panel-body   ">
               ...
               <div class="row">
                  <div class='col-sm-6 form-group' >
                     ...
                     <?= $form->field($model, 'customer_name')->textInput(['maxlength' => true,'placeholder'=>'Name','class'=>'form-control upper'])->label(false) ?>
                  </div>
                  <div class='col-sm-6 form-group' >
                   ...
                   <label class="control-label">Phone Number</label>
                      ...
                      <?= $form->field($model, 'phone')->textInput(['maxlength' => 10,'onkeypress'=>'return isNumberKey(event)'])->label(false)  ?>
                  </div>
                  <div class='col-sm-6 form-group' >
                     <!-- <h3 class="panel-title" style=" position: relative;right: 14px;">User Name</h3> -->
