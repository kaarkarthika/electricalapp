...
$this->title = 'Executive Detail View';
//$this->title = $model->id;  
              ...
              <!-- Profile Image -->
                  ...
                  <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                      <b>User Name</b> <a class="pull-right"><?= $model->name ;?></a>
                    </li>
                    
                    <li class="list-group-item">
                      <b>Phone Number</b> <a class="pull-right"><?= $model->phone; ?></a>
                    </li>
                    <li class="list-group-item">
                      <b>Address</b> <a class="pull-right"><?= $model->description; ?></a>
                    </li>
                  </ul>
