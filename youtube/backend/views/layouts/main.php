...
<div class="wrapper">
     <header class="main-header">
        ...
        <!-- <a href="<?= Yii::$app->homeUrl ?>" class="logo"> -->
         <a class="logo" href="<?= Yii::$app->homeUrl ?>">Anitha Pushpavanam Kuppusamy</a>
            ...
            <ul class="nav navbar-nav"> 
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="images/round.png" class="user-image" alt="User Image">
                  <span class="hidden-xs"><?php echo  $session['user_name'];  ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="images/round.png" class="img-circle" alt="User Image">
                    <p>
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href='<?php echo Yii::$app->homeUrl."?r=userdetails/view&id=".$session['main_id']; ?>' class="btn btn-default btn-flat"><i class="fa fa-fw fa-user"></i> Profile</a>
                    </div>
